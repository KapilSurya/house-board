      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-[#1e3d4c]">3. What We Never Do</h2>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-[#1e3d4c]">4. Data Storage and Security</h2>
            <ul className="list-disc pl-6 mb-6">
              <li>All data is stored securely via Supabase, a modern backend platform with encryption at rest and in transit</li>
              <li>Sensitive inputs like love letters and emotional logs are stored in encrypted fields</li>
              <li>Access is strictly limited and monitored</li>
            </ul>
            
            <h2 className="text-2xl font-bold mt-8 mb-4 text-[#1e3d4c]">5. Updates to This Policy</h2>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-[#1e3d4c]">6. Contact Us</h2>
