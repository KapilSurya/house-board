          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300 flex items-start">
                <span>email: </span>
                <a href="mailto:team@hivein.app" className="ml-1 hover:text-[#43B3AE] transition-colors">
                  team@hivein.app
                </a>
              </li>
              <li>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#43B3AE] transition-colors flex items-center gap-2">
