          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300 flex items-start">
                <span>email: </span>
                <a href="mailto:team@hivein.app" className="hover:text-[#43B3AE] transition-colors ml-1">
                  team@hivein.app
                </a>
              </li>
              <li className="text-gray-300">
                <a href="https://www.instagram.com/hiveinapp/" target="_blank" rel="noopener noreferrer" className="hover:text-[#43B3AE] transition-colors flex items-center gap-2">
