    ...
    <section className="pt-24 pb-16 md:pt-32 md:pb-24 gradient-bg text-white">
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
        <div className="space-y-6 animate-fade-in">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight animate-pulse-gentle">
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-4">
            <Button 
              size="lg" 
              className="bg-white text-houseboard-dark hover:bg-gray-100 btn-hover-effect text-lg px-8 py-6 transform transition-all duration-300 hover:scale-105 hover:shadow-xl"
            >
              Join Us Now
            </Button>
          </div>
