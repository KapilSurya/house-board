...
const WhoIsItFor: React.FC = () => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => {
        setIsScrollVisible(entry.isIntersecting);
      },
      { threshold: 0.3 }
    );
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div
          className={`transition-all duration-700 ease-in-out transform ${isScrollVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
        >
          ...
          <div className="grid md:grid-cols-2 gap-6 items-start">
            {/* Before View */}
            <div className="card-hover p-8 rounded-3xl candle-light h-full backdrop-blur-md">
              ...
              <div className="mt-6 rounded-xl overflow-hidden shadow-md house-window">
                <img
