        ...
        <div className={`transition-all duration-700 ease-in-out ${isScrollVisible ? 'opacity-100' : 'opacity-0'}`}>
          <div className="flex flex-col md:flex-row md:justify-end mb-12">
            <div className="md:w-2/3">
              ...
              <p className="text-lg text-[#6C7A89] max-w-2xl mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            {/* Before View */}
            <div className="bg-[#EFF3F6] text-[#094663] rounded-3xl p-8 shadow-lg transition-all duration-300 hover:shadow-xl h-full">
            ...
            {/* After View */}
            <div className="bg-[#052534] text-white rounded-3xl p-8 shadow-lg transition-all duration-300 hover:shadow-xl h-full">
              <h3 className="text-2xl font-semibold mb-4 flex items-center">
