          ...
          <div className="space-y-4 py-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="flex flex-col space-y-2">
                ...
                <Input type="email" placeholder="you@example.com" value={email} onChange={e => setEmail(e.target.value)} required className={`bg-white/20 border-white/30 text-white placeholder:text-gray-400 ${emailError ? 'border-red-500' : ''}`} />
              ...
              <Button type="submit" className="w-full bg-houseboard-medium hover:bg-[#43B3AE] text-white" disabled={isSubmitting}>
